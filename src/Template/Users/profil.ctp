    ...
    <div class="slide-1 " style="background-image: url('/img/hero.JPG');" data-stellar-background-ratio="0.5">
        ...
        <div class="row align-items-center">
            ...
            <div class="row justify-content-center align-items-center text-center">
                <div class="col-lg-6">
                <h1 data-aos="fade-up" data-aos-delay="0">Profil</h1>
                </div>
    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-lg-12 ml-auto" data-aos="fade-up" data-aos-delay="500">
                <?= $this->Form->create($user, ['type' => 'file', 'class' => 'form-box', 'id' => 'form-register']); ?>
                    <h3>Profil</h3>
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            <div class="form-group form-group-default">
                                <div id="image_preview" class="row">
                                    <div class="col-sm-6">
                                        <?= $this->Html->image('user/'.$user->picture, ['alt' => 'img-thumbnail', 'width' => '80%', 'height' => 'auto']); ?>
                                        <h5></h5>
                                    </div>
                                    <div class="col-sm-6">
