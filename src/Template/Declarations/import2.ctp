				...
				<div class="col-md-12">
					<div class="panel">
						<div class="panel-body">
							<h3>Importer le deuxième mois du DTS</h3>			
							<div class="carre">
								<?= $this->Form->create('data2_import', ['type' => 'file', 'url' => ['action' => 'import2']]); ?>
									...
									<button type="submit" class="btn btn-primary" name="Import" >Charger le mois 2</button>
								<?= $this->Form->end(); ?>
							</div>
						</div>	
					</div>				
